...
ActiveRecord::Schema.define(version: 20160929083614) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.datetime "updated_at",                       null: false
    t.integer  "user_id"
    t.boolean  "private_chatroom", default: false, null: false
    t.index ["name"], name: "index_chatrooms_on_name", unique: true, using: :btree
